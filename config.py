...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5607231107:AAHQ6XLb73K6G9qRC8yFtYkPcv8d-BwjlwE")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001897834527"))
...
GROUP = os.environ.get("GROUP", "HvH07")
